...
optimVars_ekf = [
    optimizableVariable('p_state_exp', [-19, -15], 'Type', 'real')
    optimizableVariable('p_param_exp', [-15, -11], 'Type', 'real')
    optimizableVariable('q_state_exp', [-15, -11], 'Type', 'real')
...
optimVars_dkf2 = [
    ...
    optimizableVariable('p_param_dkf2', [-29, -25], 'Type', 'real')
    optimizableVariable('q_state_dkf2', [11, 15], 'Type', 'real')
    optimizableVariable('q_param_dkf2', [-10, -6], 'Type', 'real')
    optimizableVariable('r_state_dkf2', [2, 6], 'Type', 'real')
...
optimVars_dkf1 = [
    optimizableVariable('p_state_dkf1', [-25, -21], 'Type', 'real')
    optimizableVariable('p_param_dkf1', [-26, -22], 'Type', 'real')
    optimizableVariable('q_state_dkf1', [11, 15], 'Type', 'real')
    optimizableVariable('q_param_dkf1', [-8, -4], 'Type', 'real')
    optimizableVariable('r_state_dkf1', [0, 3], 'Type', 'real')
...
%%
figure(15);
sgtitle('Damage Estimation with 8 Sensor(Most Obsv point)');
for i = 1:Ndam
