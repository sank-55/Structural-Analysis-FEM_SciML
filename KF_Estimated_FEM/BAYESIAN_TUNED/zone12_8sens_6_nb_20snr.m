...
for i = 2:N
    ...
    zst_measured(:,i) = [Phi_mat *( x_new + x_new*0.2*randn); Phi_mat *( v_new + v_new*0.2*randn)];
    zacc_measured(:,i) = Phi_mat *( a_new + a_new*0.2*randn);
...
leg_labels = {'True', 'DKF1[RMSE:0.053127]', 'DKF2[RMSE:0.051463]', ...
              'EKF[RMSE:0.061374]  \bf[Sensor:8 (SNR:20%)]\rm'};
