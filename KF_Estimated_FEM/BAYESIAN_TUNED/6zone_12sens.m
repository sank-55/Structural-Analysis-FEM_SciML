...
a=0.6; b=0.4; Nm=6; Ndam=6; N=5000; deltat=0.0001; w_1=100*pi;
nObserv=12;
...
optimVars_ekf = [
    optimizableVariable('p_state_exp', [-20, -15], 'Type', 'real')
    optimizableVariable('p_param_exp', [-18, -10], 'Type', 'real')
...
optimVars_dkf2 = [
    optimizableVariable('p_state_dkf2', [-25, -20], 'Type', 'real')
    optimizableVariable('p_param_dkf2', [-28, -22], 'Type', 'real')
    optimizableVariable('q_state_dkf2', [12, 20], 'Type', 'real')
    optimizableVariable('q_param_dkf2', [-12, -8], 'Type', 'real')
    optimizableVariable('r_state_dkf2', [1, 4], 'Type', 'real')
    optimizableVariable('r_param_dkf2', [-1, 1], 'Type', 'real')
...
optimVars_dkf1 = [
    optimizableVariable('p_state_dkf1', [-25, -20], 'Type', 'real')
    optimizableVariable('p_param_dkf1', [-28, -22], 'Type', 'real')
    optimizableVariable('q_state_dkf1', [12, 20], 'Type', 'real')
    optimizableVariable('q_param_dkf1', [-12, -8], 'Type', 'real')
    optimizableVariable('r_state_dkf1', [1, 4], 'Type', 'real')
    optimizableVariable('r_param_dkf1', [-1, 1], 'Type', 'real')
...
Pf2 = blkdiag(0.1077 , 0.0544 ,0.1292, 0.1234 ,  0.0522,  0.1149)*10^(bestP.p_param_dkf1);
...
Pf2 = blkdiag(0.1077 , 0.0544 ,0.1292, 0.1234 ,  0.0522,  0.1149)*10^(bestP.p_param_dkf2);
%Pf2 = 1e-5*blkdiag(0.1077 , 0.0544 ,0.1292, 0.1234 ,  0.0522,  0.1149);
