%% ONCE SYM COMPUTED USE THE SAVE FILE : 16NM 6MODES FOR KF AND 12 SENSOR 12 DAMAGE ZONES 
%%
clear all; close all; clc;

%% 1. PHYSICAL PARAMETERS & SYSTEM SETUP
p=1000; ro=2700; yo=70*10^9; neu=0.3; h=0.001;
a=0.6; b=0.4; Nm=6; Nm_nm=16; Ndam=12; N=5000; deltat=0.0001; w_1=100*pi;
...
%% SAVIG THE SYM EXP
save('PlateModelData_16NM.mat', 'Mgm', 'Kgk_undamaged', 'Kd', 'Phi_mat','Mgm_nm', 'Kgk_undamaged_nm', 'Kd_nm', 'Phi_mat_nm', 'Fgf', 'Fgf_nm');

%% LOADING THE DATA 
load('PlateModelData_16NM.mat');
...
optimVars_dkf2 = [
    optimizableVariable('p_state_dkf2', [-24, -22], 'Type', 'real')
    optimizableVariable('p_param_dkf2', [-24, -22], 'Type', 'real')
    optimizableVariable('q_state_dkf2', [2, 5], 'Type', 'real')
    optimizableVariable('q_param_dkf2', [-6, -4], 'Type', 'real')
    optimizableVariable('r_state_dkf2', [1, 3], 'Type', 'real')
    optimizableVariable('r_param_dkf2', [2, 4], 'Type', 'real')
    optimizableVariable('rval', [0.7, 0.9], 'Type', 'real')
...
optimVars_dkf1 = [
    ...
    optimizableVariable('p_param_dkf1', [-23, -22], 'Type', 'real')
    optimizableVariable('q_state_dkf1', [9, 11], 'Type', 'real')
    optimizableVariable('q_param_dkf1', [-9, -7], 'Type', 'real')
    optimizableVariable('r_state_dkf1', [1, 3], 'Type', 'real')
    optimizableVariable('r_param_dkf1', [-1, 2], 'Type', 'real')
...
leg_labels = {'True', 'DKF1(RMSE:0.024451)', 'DKF2(RMSE:0.022838)', ...
              'EKF(RMSE:0.04041)  \bf[Sensor:12]\rm'};
