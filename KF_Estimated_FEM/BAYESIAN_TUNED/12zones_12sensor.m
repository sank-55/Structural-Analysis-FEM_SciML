...
optimVars_dkf2 = [
    ...
    optimizableVariable('p_param_dkf2', [-30, -24], 'Type', 'real')
    optimizableVariable('q_state_dkf2', [10, 15], 'Type', 'real')
    optimizableVariable('q_param_dkf2', [-10, -6], 'Type', 'real')
    optimizableVariable('r_state_dkf2', [2, 5], 'Type', 'real')
...
optimVars_dkf1 = [
    ...
    optimizableVariable('q_param_dkf1', [-10, -6], 'Type', 'real')
